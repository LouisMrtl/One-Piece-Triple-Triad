...
const CARD_POOL = {
  ...
  pirate1: { id:'pirate1', name:'Recrue pirate',      top:1, right:1, bottom:0, left:0 },
  pirate2: { id:'pirate2', name:'Matelot pirate',      top:0, right:0, bottom:1, left:1 },
  pirate3: { id:'pirate3', name:'Jeune pirate',        top:2, right:1, bottom:0, left:0 },
  ...
  luffy:   { id:'luffy',   name:'Monkey D. Luffy',   top:7, right:5, bottom:4, left:8 },
  zoro:    { id:'zoro',    name:'Roronoa Zoro',      top:8, right:6, bottom:5, left:3 },
  nami:    { id:'nami',    name:'Nami',              top:4, right:7, bottom:5, left:6 },
  usopp:   { id:'usopp',   name:'Usopp',             top:5, right:4, bottom:3, left:7 },
  sanji:   { id:'sanji',   name:'Sanji',             top:8, right:7, bottom:5, left:4 },
  chopper: { id:'chopper', name:'Tony Tony Chopper', top:4, right:5, bottom:7, left:3 },
  robin:   { id:'robin',   name:'Nico Robin',        top:6, right:7, bottom:6, left:6 },
  franky:  { id:'franky',  name:'Franky',            top:7, right:8, bottom:4, left:5 },
  brook:   { id:'brook',   name:'Brook',             top:6, right:5, bottom:4, left:7 },
  jinbe:   { id:'jinbe',   name:'Jinbe',             top:8, right:6, bottom:8, left:5 },
  coby:    { id:'coby',    name:'Coby',              top:2, right:3, bottom:2, left:3 },
  alvida:  { id:'alvida',  name:'Alvida',            top:2, right:3, bottom:1, left:2 },
  buggy:   { id:'buggy',   name:'Buggy le Clown',    top:3, right:5, bottom:2, left:4 },
  mohji:   { id:'mohji',   name:'Mohji',             top:2, right:2, bottom:1, left:3 },
  cabaji:  { id:'cabaji',  name:'Cabaji',            top:3, right:4, bottom:2, left:3 },
  kuro:    { id:'kuro',    name:'Kuro',              top:5, right:3, bottom:4, left:6 },
  django:  { id:'django',  name:'Django',            top:2, right:4, bottom:2, left:3 },
  sham:    { id:'sham',    name:'Sham',              top:2, right:2, bottom:3, left:2 },
  krieg:   { id:'krieg',   name:'Don Krieg',         top:5, right:5, bottom:3, left:5 },
...
function getCardImageId(id){
  return { pirate1:'pir1', pirate2:'pir2', pirate3:'pir3' }[id] || id;
}
...
function cardImagePaths(id){
  ...
  const frames = [1, 2, 3].map(n => `images/characters/${imageId}/${n}.png`);
  return {
    portrait: `images/characters/${imageId}/${imageId}.png`, // carte principale fixe
